  ...
  const exportToExcel = async () => {
    ...
    let html = `
      ...
      <head>
        ...
        <style>
          ...
          .subheader .badge { background: #059669; color: white; padding: 3px 10px; border-radius: 12px; font-size: 10px; font-weight: 600; }
          table { border-collapse: collapse; width: 100%; font-size: 11px; border-left: 4px solid #059669; border-right: 4px solid #059669; }
          th { background: #047857; color: white; padding: 11px 8px; text-align: left; font-weight: 600; font-size: 10px; text-transform: uppercase; }
          ...
          .category-badge { padding: 3px 10px; border-radius: 12px; font-size: 10px; font-weight: 600; display: inline-block; }
          ...
          .footer { background: #f9fafb; padding: 12px 25px; border: 4px solid #059669; border-top: 3px solid #059669; border-radius: 0 0 10px 10px; font-size: 10px; color: #6b7280; display: flex; justify-content: space-between; align-items: center; }
      ...
      <body>
        ...
        <div class="subheader" style="border-top:none;padding-top:5px;">
          ...
          <span>🔍 Filters: <strong>${search || 'None'}</strong></span>
        </div>
        <table>
          <thead>
            <tr>
    ...
    dataToExport.forEach((p, i) => {
      ...
      html += `
        <tr>
          <td>${i + 1}</td>
          <td style="font-family:Consolas,monospace;font-size:10px;color:#6b7280">${p.item_code || 'N/A'}</td>
          <td><div class="item-name">${p.name || 'Unnamed Product'}</div></td>
