...
body{font-family:Arial,sans-serif;font-size:13px;color:#1a1a1a;background:#fff;padding:25px;width:700px}
h1{font-size:20px;color:#0D2D4A;margin:0}h2{font-size:15px;color:#1B5080;margin:5px 0}
...
<p style="font-size:10px;color:#555">Innovation Without End | 2220 Manthata Street, Midrand | 070 419 9457</p>
<div class="hr"></div>
...
<div class="section"><div class="stitle">Summary</div><p style="font-size:11px">Quotation: <b>${quotation.quotation_number}</b></p><p style="font-size:11px">Total: <b style="font-size:15px;color:#059669">${fmt(quotation.total_amount)}</b></p></div>
<div class="section"><div class="stitle">Banking Details</div><p style="font-size:10px"><b>Bank:</b> Capitec Business | <b>Branch:</b> 450105</p><p style="font-size:10px"><b>Account:</b> 1054498946 | <b>Ref:</b> ${quotation.quotation_number}</p></div>
<div class="total-box"><p>TOTAL: ${fmt(quotation.total_amount)}</p></div>
<div class="ft"><p>www.ndandulenigroup.co.za | account@ndandulenigroup.co.za | 070 419 9457</p></div>
</body></html>`

      const container = document.createElement('div')
      container.innerHTML = html
      container.style.cssText = 'position:fixed;left:0;top:0;width:700px;background:white;z-index:99999;'
